...
def main(config_path, params_path):
    ...
    logging.info("updating device configuration as per cuda availability")
    ...
    logging.info("Donloading training and testing data")
    ...
    logging.info("defining training and testing data data loader")
